...
const Sidebar = ({ openMenu, setOpenMenu }) => {
    ...
    const sendBG = (bg) => {
        ...
        axios.put(`/upload/bd/${id}`, { background: bg })
        changeBG(bg);
    }

    const defaultUrl = "https://i.pinimg.com/originals/47/0a/19/47-a19a36904fe200610cc1f41eb00d9.jpg"
                    ...
                    <div className={classes.menu}>
                        ...
                        {images.map(image => (
                            <div className={classes.box}
                                key={image.id}
                                style={{
                                    backgroundImage: `url(${image.thum})`,
                                    backgroundPosition: 'center',
                                    backgroundRepeat: 'no-repeat',
                                    backgroundSize: 'cover'
                                }}
