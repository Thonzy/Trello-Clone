...
const clientSocket = io('https://trello-be-31x4.onrender.com');
    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.loginBox}>
                <img src="https://cdn0.iconfinder.com/data/icons/navigation-elements-1/512/green-app-grid-menu-title-choice-app-512.png" alt=""
